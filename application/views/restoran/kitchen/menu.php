            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="<?php echo base_url() ?>Restoran/kitchen/kelola_pesanan"><i class="fa fa-edit"></i> Kelola Pesanan</a></li>
                  ...
                  <li><a><i class="fa fa-desktop"></i> Kelola Stok <span class="fa fa-chevron-down"></span></a>
                     <ul class="nav child_menu">
                      ...
                      <li><a href="<?php echo base_url() ?>Restoran/kitchen/stok_makanan">Bahan Makanan</a></li>
                    </ul>
                  </li>

                  <li><a href="<?php echo base_url() ?>Restoran/kitchen/pengajuan_stok_BM"><i class="fa fa-arrow-circle-up"></i> Pengajuan Stok</a></li>
                  <li><a href="<?php echo base_url() ?>Restoran/kitchen/penerimaan_stok_BM"><i class="fa fa-arrow-circle-down"></i> Penerimaan Stok</a></li>
                </ul>
              </div>
