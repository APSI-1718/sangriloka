            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="<?php echo base_url() ?>Restoran/kitchen/kelola_order"><i class="fa fa-edit"></i> Kelola Order</a></li>
                  ...
                  <li><a href="<?php echo base_url() ?>Restoran/kitchen/pengajuan_stok"><i class="fa fa-arrow-circle-up"></i> Pengajuan Stok</a></li>
                  <li><a href="<?php echo base_url() ?>Restoran/kitchen/penerimaan_stok"><i class="fa fa-arrow-circle-down"></i> Penerimaan Stok</a></li>
                </ul>
              </div>
