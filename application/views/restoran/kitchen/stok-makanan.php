...
<div class="clearfix"></div>
            ...
            <div class="row">
              ...
              <?php
              $berhasil = $this->session->flashdata('editdatamkn');
              if ((isset($berhasil)) && (!empty($berhasil))) {?>
              <div class="alert alert-success alertmakanan">
              <a href="#" class="close" data-dismiss="alert">&times;</a>
              <?php print_r($berhasil);?>
              ...
              <?php } ?>
               ...
               <?php
              $berhasil = $this->session->flashdata('deletedatamkn');
              if ((isset($berhasil)) && (!empty($berhasil))) {?>
              <div class="alert alert-success alertmakanan">
              <a href="#" class="close" data-dismiss="alert">&times;</a>
              <?php print_r($berhasil);?>
                       ...
                       <?php $i=1; foreach ($kitchen as $value) { ?>
                             ...
                             <?php } ?>
                                ...
                                <td>
                                  ...
                                  <?php
                                echo "
                                        <button type='button' class='btn btn-primary btn-xs tombolmkn'
                                              data-toggle='modal' data-target='#editmknModal'
                                              data-kode_mkn='". $value['kode_mkn']."'
                                              data-nama_mkn='". $value['nama_mkn']."'
                                              data-jenis_mkn='". $value['jenis_mkn']."'>
                                              <i class='fa fa-pencil-square-o'></i> Ubah
                                       </button>&nbsp;&nbsp;
                                      <button type='button' class='btn btn-danger btn-xs tombolmkn'
                                          data-toggle='modal' data-target='#deletemknModal'
                                          data-kode_mkn='". $value['kode_mkn']."'
                                          data-nama_mkn='". $value['nama_mkn']."'><i class='glyphicon glyphicon-trash'></i> Hapus
                                      </button>
        ...
        <div class="modal-body">
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo base_url()?>Restoran/kitchen/stok_makanan/tambah_data">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="hidden" id="stok_mkn" name="stok_mkn" required="required" class="form-control col-md-7 col-xs-12 stok_mkn" value="0">
                        </div>
                      </div>
        </div>
...
<div class="modal fade" id="editmknModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" >
    <div class="modal-dialog" role="document" >
      <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title editmkn" id="editModalLabel">Ubah Data</h4>
        </div>
        <div class="modal-body">
          <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo base_url() ?>Restoran/kitchen/stok_makanan/edit_data">
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama_mkn">Kode Makanan <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
...
<div class="modal fade" id="deletemknModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" >
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title" id="deletemknModalLabel">Hapus Data</h4>
        </div>
        <div class="modal-body">
          <div class="delete alert alert-danger"></div>
        </div>
        <div class="modal-footer">
            <form method="post" action="<?php echo base_url() ?>Restoran/kitchen/stok_makanan/delete_data">
              <input type="hidden" name="kode_mkn" class="form-control kode_mkn" id="kode_mkn">
          <button type="button" class="btn btn-btn-default" data-dismiss="modal">Batal</button>
