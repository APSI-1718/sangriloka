              ...
              <div class="title_left">
                <div class="col-md-4 col-sm-6 col-xs-6 form-group">
                  <div class="input-group">
                   <a href="../notifikasi/promosi" class="btn btn-default btn-sm" type="button" ><i class="fa fa-chevron-left">&nbsp; Kembali</i></a>
                    ...
                    <li>
                      <div class="block">
                        ...
                        <div class="block_content">
                          <h2 class="title">
                                          <a href="#"><?php echo $value ['judul_promosi']; ?></a>
                                      </h2>
                          <div class="byline">
                            <span><?php echo $value ['waktu_tanggal']; ?></span>
                          </div>
                          <p class="excerpt"><?php echo word_limiter( $value ['isi_promosi'], 23); ?>
                          </p>
                        </div>
                      </div>
                    </li>
                  ...
                  <ul class="list-unstyled timeline">
                    <li>
                         <center>
                            ...
                            <button href="#" class="btn btn-info btn-sm tombol3" data-toggle="modal" data-target="#modaleditpromosi" data-id="<?php echo $value ['id_promosi'];?>" data-judul="<?php echo $value ['judul_promosi'];?>" data-isi="<?php echo $value ['isi_promosi'];?>" ><i class="fa fa-pencil"></i> Ubah </button>
                            
                            <button href="#" class="btn btn-danger btn-sm tombol3" data-toggle="modal" data-target="#modalhapuspromosi" data-id="<?php echo $value ['id_promosi'];?>" data-judul="<?php echo $value ['judul_promosi'];?>"><i class="fa fa-trash-o"></i> Hapus </button>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div id="testmodal" style="padding: 5px 20px;">
              <form id="antoform" class="form-horizontal calender" role="form" method="post" action="<?php echo base_url() ?>notifikasi/detail_promosi/insert_data" >
    ...
    <div id="modaleditpromosi" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div id="testmodal" style="padding: 5px 20px;">
              <form id="antoform" class="form-horizontal calender" role="form" method="post" action="<?php echo base_url() ?>notifikasi/detail_promosi/edit_data" >
                <div class="form-group">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div id="testmodal" style="padding: 5px 20px;">
              <form id="antoform" class="form-horizontal calender" role="form" method="post" action="<?php echo base_url() ?>notifikasi/detail_promosi/delete_data" >
                <div class="form-group">
