...
$pdf = new FPDF('l','mm',array('155','155'));
//membuat halaman baru
$pdf->AddPage();
//setting jenis font yang akan digunakan
$pdf->SetFont('Arial','B',16);
//mencetak string
$pdf->Cell(190,7,'                       Hotel Sangriloka',0,1,'');
...
foreach ($pembayaran as $key => $value) {
	$pdf->Cell(22,6,$value['id_pembayaran'],0,0);
	$pdf->Cell(35,6,$value['nama_pendaftar'],0,0);
	$pdf->Cell(35,6,$value['Qty'],0,0);
	$pdf->Cell(35,6,"Rp. ".$value['Total'],0,0);
	$pdf->Cell(22,6,$value['tgl_transaksi'],0,1);
}
...
$pdf->Cell(57,6,'',0,0);
$pdf->Cell(27,6,"Rp. ".number_format($this->input->post('Total'),0,",","."),0,0);
