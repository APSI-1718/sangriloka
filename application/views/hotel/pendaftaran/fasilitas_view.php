...
<div class="clearfix"></div>
 ...
 <!-- Flash Data -->
        ...
        <?php } ?>
             ...
             <button type="button" class="btn btn-info fa fa-plus-circle" data-toggle="modal" data-target="#tambahModal"> Fasilitas</button>
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        foreach ($fasilitas as $key =>$value){ ?>
                          ...
                          <td>
                          <button class="btn btn-info" data-toggle='modal' data-target="#edit<?php echo $value['id_fas'];?>"><i style="color: white" class="fa fa-pencil-square-o" aria-hidden="true"></i></button>

                            <a href='<?php echo base_url() ?>hotel/Pemesanan/Fasilitas/hapus_fasilitas/<?php echo $value['id_fas']?>' onclick="javascript: return confirm('Anda Yakin Ingin Menghapus Data?')"><button type="button" class="btn btn-danger"><i style="color: white" class="fa fa-trash-o" aria-hidden="true"></i></button></a></td>  
                          </tr>
                      <?php $i++;}?>
                      </tbody>
                    </table>
