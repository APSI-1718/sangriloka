                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div class="container">
                      <div class="row">
                        <div class="col-md-5">
                          <form action="<?php echo base_url('outbound/inventory_outbound/peralatan/tambah_peralatan') ?>" method="POST" role="form">
                            <legend>Form Tambah Peralatan</legend>
                              <div class="form-group">
                                <label for=""></label>
                                <input type="hidden" class="form-control" name="id" placeholder="Masukan ID Peralatan">
                                <label for="">Nama Peralatan</label>
                                <input type="text" class="form-control" name="nama" placeholder="Masukan nama Peralatan">
