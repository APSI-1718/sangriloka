                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div class="container">
                      <div class="row">
                        <div class="col-md-5">
                          <form action="<?php echo base_url('outbound/inventory_outbound/pengajuan/tambah_pengajuan') ?>" method="POST" role="form">
                            <legend>Form Tambah Pengajuan</legend>
                              <div class="form-group">
                                <label for=""></label>
                                <input type="text" class="form-control" name="id_pengajuan" placeholder="Masukan ID Pengajuan">
                                <label for="">Tanggal Pengajuan</label>
                                <input type="text" class="form-control" name="tanggal_pengajuan" value="<?php echo $tanggal ?>" readonly>
                                <label for="">Keterangan Pengajuan</label>
                                <input type="text" class="form-control" name="keterangan_pengajuan" placeholder="Masukan Jenis">
                                <label for="">Jumlah</label>
                                <input type="text" class="form-control" name="jumlah" placeholder="Masukan Jumlah">
                                <label for="">Jenis</label>
                                <input type="text" class="form-control" name="jenis" placeholder="Masukan Keterangan">
